...
if(default==1)
 ...
 pwav=pwave(x,a_pwav,d_pwav,t_pwav,li);
 %qwav output
 qwav=qwave(x,a_qwav,d_qwav,t_qwav,li);
 %qrswav output
 qrswav=qrswave(x,a_qrswav,d_qrswav,li);
 %swav output
 swav=swave(x,a_swav,d_swav,t_swav,li);
 %twav output
 twav=twave(x,a_twav,d_twav,t_twav,li);
 %uwav output
 uwav=uwave(x,a_uwav,d_uwav,t_uwav,li);
 %ecg output
